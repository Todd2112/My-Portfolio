...
Our solution is built upon a three-part architecture:

1. Local knowledge base  
2. Self-correction algorithm  
3. Conversational human-in-the-loop (HITL) feedback mechanism  
...
$$
D = \frac{1}{2} \left[ 
(1 - \text{cosine\_similarity}(V_R, V_{A_k})) + 
...
$$
C_f = \min\left(1.0, \max\left(0.0, C_r \times (1 - D)\right)\right)
$$
